...
/*
	public static void latLongToXYZ(Coordinate ll, Point3D xyz) {
	...
	public static void xyzToLatLong(Point3D xyz, Coordinate ll) {
...
*/
	...
	public static int intersectSegments(Coordinate aStart, Coordinate aEnd, Coordinate bStart, Coordinate bEnd, Coordinate p) {
	...
	public static Coordinate perpendicular(Coordinate a) {
	...
	public static void normalize(Coordinate a) {
		double d = distance(a.x, a.y);
		a.x /= d;
		a.y /= d;
	}
	
	public static void negate(Coordinate a) {
		a.x = -a.x;
		a.y = -a.y;
	}
