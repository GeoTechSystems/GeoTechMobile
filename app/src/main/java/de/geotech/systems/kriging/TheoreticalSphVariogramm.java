...
public class TheoreticalSphVariogramm {

    String typ = "Sph";
    double lagCenter[], semiVariances[], nugget, sill, range;

    public TheoreticalSphVariogramm(double[] lagCenter, double[] semiVariances) {
    ...
    public void calculateNuggetSillRange() {
        ...
        CurveFitter<SphFunction> fitter = new CurveFitter<SphFunction>(optimizer);
        ...
        SphFunction function = new SphFunction();
